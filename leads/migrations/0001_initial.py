# Generated by Django 3.1.4 on 2023-08-01 13:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.date(2023, 8, 1))),
                ('start_time', models.TimeField(blank=True, null=True)),
                ('end_date', models.DateField(default=datetime.date(2023, 8, 1))),
                ('end_time', models.TimeField(blank=True, null=True)),
                ('referenceURL', models.CharField(max_length=300)),
                ('referenceNotes', models.CharField(max_length=500)),
                ('alert', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.alertoptions')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attendee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.userprofile')),
        ...
        migrations.AddField(
            model_name='task',
            name='showAs',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.calendardisplayoptions'),
        ),
        migrations.AddField(
            model_name='task',
            name='travel_time',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.traveltimeoptions'),
        ),
        migrations.CreateModel(
            name='Parties',
            fields=[
